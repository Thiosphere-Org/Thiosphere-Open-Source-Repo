# Thiosphere - Espacios Modulares de Código Abierto
...
## 🌍 Selección de Idioma / Language Selection / Sprachauswahl / Sélection de Langue / Språkval / Kielen Valinta
...
# Espacios Modulares de Código Abierto
...
Un thiosphere está hecho con el menor número posible de piezas, pero resulta en un espacio modular fuerte, ligero y espacioso que solo ocupa 1/2 de una plaza de estacionamiento. Es empaquetable plano y se puede ensamblar con herramientas comunes. Es modular para que puedas crear un número infinito de espacios, desde un refugio simple hasta una oficina compleja. Es tanto funcional como hermoso, y está diseñado para ser un segundo lugar donde la vida pueda florecer - sea lo que sea y donde sea que estén esos requisitos.
...
- **Inteligente en Energía**: Diseño pasivo reduce las necesidades de energía en un 80%
...
**Materiales:**
- 180 - maderas 2x4
- 4 - láminas de contrachapado 4'x8'
- 120 - tuercas y tornillos
- 800 - tornillos para madera
- 4 ruedas, un remolque pequeño o un pedestal de nivelación (opcional)

**Herramientas:**
- Sierra de inglete compuesto
...
- Cortar 2x4s para crear piezas de borde anguladas
- Necesitarás aproximadamente 60 piezas para cúpula exterior, 60 para cúpula interior
...
**Comenzar con el anillo base:**
1. Colocar tu primer anillo de piezas en una superficie plana
2. Unir piezas usando los ángulos calculados
3. Usar tornillos GRK para asegurar juntas
4. Verificar redondez y ajustar según sea necesario

**Construir hacia arriba en anillos:**
1. Cada anillo se conecta al de abajo
2. Mantener espaciado consistente entre cúpulas interior y exterior
3. Usar soportes temporales para mantener piezas en su lugar
4. Trabajar en secciones para mantenerlo sólido

#### 4. Agregar los Paneles

**Cortar paneles de contrachapado:**
- Medir cada abertura entre piezas del marco
- Cortar paneles para ajustar con 1/4" de espacio para expansión
- Lijar bordes suavemente

**Instalar paneles:**
1. Aplicar sellador de silicona a bordes del marco
2. Presionar paneles en su lugar
3. Asegurar con tornillos alrededor del perímetro
4. Limpiar sellador excesivo

#### 5. Impermeabilizarlo

**Sellar todas las juntas:**
- Aplicar sellador de silicona a todas las juntas exteriores
- Prestar atención especial a bordes de paneles
- Dejar curar por 24 horas

**Aplicar acabado:**
- Pintar o sellar todas las superficies de madera
- Usar pintura de grado exterior para uso exterior
- Aplicar múltiples capas para durabilidad

### Consejos Pro

- **Tómate tu tiempo**: La precisión al cortar ángulos es clave
- **Prueba de ajuste**: Ensamblar secciones en seco antes del ensamblaje final
- **Usar plantillas**: Crear plantillas simples para mantener piezas en ángulos correctos
- **Trabajar en parejas**: Algunos pasos de ensamblaje son más fáciles con ayuda
- **Verificar medidas**: Verificar cada pieza antes de cortar

### Recursos

- [Calculadora de Sierra de Inglete Compuesto](https://jansson.us/jcompound.html) - Esencial para calcular ángulos precisos
- [Tornillos GRK FIN/Trim™](https://grkfasteners.ca/product/fin-trim-finishing-trim-head-screw/) - Recomendado para acabado limpio
- [Hardware McMaster-Carr](https://www.mcmaster.com/90273A572/) - Para sujetadores y hardware adicionales
...
**Thiospheres - Domus Opus Est** (el trabajo de crear espacio nunca termina).
